...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
       ...
       yield MenuItem::linkToCrud('Promotionen', 'fas fa-address-card', Promotion::class);
       yield MenuItem::linkToCrud('Reservierungen', 'fas fa-address-card', Reservation::class);
