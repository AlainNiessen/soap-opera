 ...
 */
final class Version20220415140300 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Création table réservations + relation Reservation-Event Reservation-Facture';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE reservation (id INT AUTO_INCREMENT NOT NULL, event_id INT NOT NULL, facture_id INT NOT NULL, date_reservation DATETIME NOT NULL, INDEX IDX_42C8495571F7E88B (event_id), INDEX IDX_42C849557F2DEE08 (facture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
