 ...
 */
final class Version20220831101320 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Changement état initiale';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE philosophie DROP FOREIGN KEY FK_6F27F9522AADBACD');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE facture DROP FOREIGN KEY FK_FE866410FB88E14F');
        $this->addSql('ALTER TABLE facture ADD CONSTRAINT FK_FE866410FB88E14F FOREIGN KEY (utilisateur_id) REFERENCES utilisateur (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE newsletter DROP FOREIGN KEY FK_7E8585C815A4A5BD');
        ...
        $this->addSql('ALTER TABLE philosophie DROP FOREIGN KEY FK_6F27F9522AADBACD');
        $this->addSql('ALTER TABLE philosophie ADD CONSTRAINT FK_6F27F9522AADBACD FOREIGN KEY (langue_id) REFERENCES langue (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE traduction_article DROP FOREIGN KEY FK_3C05A2162AADBACD');
        $this->addSql('ALTER TABLE traduction_article DROP FOREIGN KEY FK_3C05A2167294869C');
